...
! VERSION           : V 0.0
! HISTORY           : 2022-05-30, created by Jiongming Pang for testing LBUOY reading.
!
!   Created by Jiongming Pang for LBUOY obs (pang.j.m@hotmail.com), 2022/5/30, @GBA-MWF, Shenzhen
!
!!--------------------------------------------------------------------------------------------------
...
PROGRAM Test_ObsRead
  ...
  configFile = TRIM(configFile)//"/UnitTest/testMiniSolver_LBUOY.yaml"
