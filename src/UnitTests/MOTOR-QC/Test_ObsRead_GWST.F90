...
! VERSION           : V 0.0
! HISTORY           : 2022-07-15, created by Jiongming Pang for testing GWST reading.
!
!   Created by Jiongming Pang for GWST obs (pang.j.m@hotmail.com), 2022/7/15, @GBA-MWF, Shenzhen
!
!!--------------------------------------------------------------------------------------------------
...
PROGRAM Test_ObsRead
  ...
  configFile = TRIM(configFile)//"/UnitTest/testMiniSolver_GWST.yaml"
