...
PROGRAM Test_QRdecomp_invRv2
  ...
  ! CALL BKErr%b_qrDecomp_save(datFileName, 1, status)
  ...
  PRINT *, "MAXVAL(ABS(invR_cal - invR_true)):", MAXVAL(ABS(BKErr%Rinv - invR))

END PROGRAM Test_QRdecomp_invRv2
