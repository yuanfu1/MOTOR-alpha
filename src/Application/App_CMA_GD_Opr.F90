...
!   Yali Wu: obslist is no longer useful for satellite data assimilation.
!            Note to set which instruments you need to assimilate in the RTTOV section of YAML.
!!--------------------------------------------------------------------------------------------------
!!
!> @brief
...
PROGRAM App_CMA_GD
  ...
  CHARACTER(LEN=8), PARAMETER :: &
    ...
    ! obsList(2) = (/'surfaces','sounding'/) ! Individual test of cons
  !  obsList(1) = (/'fy4_agri'/) ! Individual test of cons
    ...
    ! obsList(3) = (/'surfaces','sounding', 'fy4_agri'/)
    ! obsList(1) = (/'sounding'/)
    ! obsList(2) = (/'fy4_agri', 'fy4_giirs'/)
    ! obsList(1) = (/'sounding'/)     ! Individual test of reflectivity
    ! obsList(3) = (/'surfaces', 'sounding', 'profiler'/) ! Individual test of cons
    obsList(3) = (/'surfaces', 'sounding', 'radarVel'/) ! Individual test of cons
...
4   FORMAT('Observations have been processed successively')
    ...
    ! Check the O-B: used for testing to uncover the following 3 lines:
    ! app%analysis = app%XbMG(app%mgEnd)
    ! print*,'O-B: ',app%XbMG(app%mgEnd)%sg%glevel !app%analysis%sg%gLevel
