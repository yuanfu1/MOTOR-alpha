...
CONTAINS
  ...
  SUBROUTINE RH_psi_func(this, attime, latlon, zhght, stream, vortct)
    ...
    PRINT *, 'test UnitestDyn Function'
  ...
  SUBROUTINE VorTen(this, latlon, vortct, divergence, psi, chi, DM, tenvor, X1)
    ...
    DO k = 1, this%vLevel
      ...
      DO i = 1, this%num_cell
        ...
        F_DM_psisigma(k, i) = 2.0D0 / R0**3 * this%DM1st(1, k, i) * this%psi1st(2, k, i) &
                              + 2.0D0 / R0**3 * this%DM1stLambda_dclat(k, i) * this%psi1st_dclat(2, k, i) &
                              + 2.0D0 / R0 * DM(k, i) * vortct(k, i)

        J_DM_chisigma(k, i) = 2.0D0 / R0**3 * this%DM1st(2, k, i) * this%chi1st_dclat(1, k, i) &
                              - 2.0D0 / R0**3 * this%DM1st(1, k, i) * this%chi1st_dclat(2, k, i)
