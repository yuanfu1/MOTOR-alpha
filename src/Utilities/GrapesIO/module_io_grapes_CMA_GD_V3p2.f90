...
!!===================================================================
MODULE module_io_grapes_CMA_GD_V3p2_m
  USE module_domain
  ...
  TYPE, EXTENDS(module_io_grapes_t) :: module_io_grapes_CMA_GD_V3p2_t
...
CONTAINS
  SUBROUTINE initialize(this, hgrid, nlFileName, giFileName)
    CLASS(module_io_grapes_CMA_GD_V3p2_t)   :: this
