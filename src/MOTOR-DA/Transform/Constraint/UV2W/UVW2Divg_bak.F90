      ...
      BLOCK
        ...
        DO i = 1, sg%num_icell
          ...
          IF ((sg%cell_stcl(4, i) .EQ. 0)) THEN
            ...
            pZspx(i) = sg%zHght(1, sg%cell_stcl(5, i)) * t1 + &
                       sg%zHght(1, sg%cell_stcl(6, i)) * t2 + &
                       sg%zHght(1, sg%cell_stcl(6, sg%cell_stcl(6, i))) * t3
          END IF
          ...
          IF ((sg%cell_stcl(6, i) .EQ. 0)) THEN
            ...
            pZspx(i) = sg%zHght(1, sg%cell_stcl(4, sg%cell_stcl(4, i))) * t1 + &
                       sg%zHght(1, sg%cell_stcl(4, i)) * t2 + &
                       sg%zHght(1, sg%cell_stcl(5, i)) * t3
          END IF
          ...
          IF ((sg%cell_stcl(2, i) .EQ. 0)) THEN
            ...
            pZspy(i) = sg%zHght(1, sg%cell_stcl(5, i)) * t1 + &
                       sg%zHght(1, sg%cell_stcl(8, i)) * t2 + &
                       sg%zHght(1, sg%cell_stcl(8, sg%cell_stcl(8, i))) * t3
          END IF
          ...
          IF ((sg%cell_stcl(8, i) .EQ. 0)) THEN
            ...
            pZspy(i) = sg%zHght(1, sg%cell_stcl(2, sg%cell_stcl(2, i))) * t1 + &
                       sg%zHght(1, sg%cell_stcl(2, i)) * t2 + &
                       sg%zHght(1, sg%cell_stcl(5, i)) * t3
          END IF
        END DO
        ...
        DO i = 1, sg%vLevel - 1
          this%c1(i, :) = (sg%ztop - (sg%sigma(i) + sg%sigma(i + 1)) / 2.0D0) / (sg%ztop - sg%zHght(1, :)) * pZspx
          this%c2(i, :) = (sg%ztop - (sg%sigma(i) + sg%sigma(i + 1)) / 2.0D0) / (sg%ztop - sg%zHght(1, :)) * pZspy
      ...
      BLOCK
        ...
        DO j = 1, X%sg%num_icell
          ...
          DO i = 1, X%sg%vLevel - 1
            ...
            PRINT *, this%coef_p_pX(:, j), j

            DO vStcl = 1, 2
              divg(i, j, :) = divg(i, j, :) &
                              - this%c1(i, j) * uwnd(this%stcl_p_pSigma(vStcl, i), j, :) * this%coef_p_pSigma(vStcl, i) &
                              - this%c2(i, j) * vwnd(this%stcl_p_pSigma(vStcl, i), j, :) * this%coef_p_pSigma(vStcl, i) + &
                              this%c3(j) * wwnd(this%stcl_p_pSigma(vStcl, i), j, :) * this%coef_p_pSigma(vStcl, i)
            END DO
            PRINT *, this%coef_p_pSigma(:, i)
            STOP
