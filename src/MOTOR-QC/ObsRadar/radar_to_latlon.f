...
cdoc    of radar echo
        ...
        real*8 rlat_radar             ! I    (Degrees)
        real*8 rlon_radar             ! I    (Degrees)
        real*8 rheight_radar          ! I    (Meters)
        real*8 azimuth                ! I    (Degrees)
        real*8 slant_range            ! I    (Meters)
        real*8 elev                   ! I    (Degrees)
        real*8 lat_grid               ! O    (Degrees)
        real*8 lon_grid               ! O    (Degrees)
        real*8 height_grid            ! O    (Meters)
