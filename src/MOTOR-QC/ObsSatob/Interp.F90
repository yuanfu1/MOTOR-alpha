...
!  USE ObsSatob_m, ONLY: ObsSatob_t
  IMPLICIT NONE
...
CONTAINS
  ...
  SUBROUTINE Intp2DWeight(this, lat_ob, lon_ob, lats, lonw, dlat, dlon, mi, mj, &
...
! south pole
  ...
  SUBROUTINE VerticalWeight(this, pre, ko, dp, dpm)
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!  Discription:
...
!---------------------------------------------------------------------------
  ...
  SUBROUTINE VerticalWeight_h(this, height, xbheight, ko, dp, dpm, mkp)
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!  Discription:
...
!---------------------------------------------------------------------------
  ...
  SUBROUTINE Gposition(this, iy, jx, i, j, isw, ise, inw, ine, jsw, jse, jnw, jne)
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
! Description:
...
!------------------------------------------------------------------------------
  ...
  SUBROUTINE UvConvert(this, lat, lon, U, V, MTYPE)
!--------------------------------------------------------------------
! Purpose
...
!END MODULE module_interpolation
  ...
  SUBROUTINE Intp2DWeight2(this, lat_ob, lon_ob, slat, wlon, dlat, dlon, iy, jx, &
