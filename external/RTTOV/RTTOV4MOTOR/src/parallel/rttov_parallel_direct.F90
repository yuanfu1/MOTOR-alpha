! Description:
!> @file
!!   Runs the RTTOV direct model with multiple threads under OpenMP.
!
!> @brief
!!   Runs the RTTOV direct model with multiple threads under OpenMP.
!!
...
!!   compiler flags.
!!
!!   The arguments are identical to those for rttov_direct.F90 though
!!   the traj argument cannot be used with the parallel interface.
!!
