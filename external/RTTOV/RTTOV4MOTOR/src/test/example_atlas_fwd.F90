! Description:
!> @file
!!   Example calling direct model clear-sky simulation obtaining surface
!!   emissivity and/or BRDF data from the atlases.
!
!> @brief
!!   Example calling direct model clear-sky simulation obtaining surface
!!   emissivity and/or BRDF data from the atlases.
!!
!! @details
!!   This example is most easily run using the run_example_atlas_fwd.sh
!!   script (see the user guide).
!!
!!   This program requires the following files:
!!     the file containing input profiles (e.g. prof.dat)
!!     the RTTOV optical depth coefficient file
!!     the atlas data files, assumed to be in the top-level emis_data/ and
!!        brdf_data/ directories
!!
!!   The output is written to a file called example_atlas_fwd_output.dat
!!
!!   This program is very similar to example_fwd.F90 with the addition
!!   of calls to the atlases.
!!
