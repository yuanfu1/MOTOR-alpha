...
!!
!! @details
!!   This example is most easily run using the run_example_cld_file_fwd.sh
...
!!
!!   The output is written to a file called example_cld_file_fwd_output.dat
!!
...
#include "rttov_skipcommentline.interface"
  ...
  CHARACTER(LEN=20)  :: NameOfRoutine = 'example_cld_file_fwd'
...
!     CALL rttov_skipcommentline(iup, errorstatus)
  ...
  profiles(:) % clw_scheme = 1    ! OPAC CLW properties
  profiles(:) % ice_scheme = 2    ! Baran2014 ice properties
...
END PROGRAM example_cld_file_fwd
