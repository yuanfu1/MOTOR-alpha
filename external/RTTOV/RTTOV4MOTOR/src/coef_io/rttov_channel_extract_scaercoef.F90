...
!
SUBROUTINE rttov_channel_extract_scaercoef(err, coef_scatt1, coef_scatt2, channels)
!INTF_OFF
#include "throw.h"
...
#include "rttov_errorreport.interface"
  ...
  CALL channel_extract_optp(err, coef_scatt1%optp_aer, coef_scatt2%optp_aer, channels)
  THROW(err.NE.0)
