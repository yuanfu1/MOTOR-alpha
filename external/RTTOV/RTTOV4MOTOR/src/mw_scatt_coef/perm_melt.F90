...
!INTF_OFF
use mod_scattering, only : density_wat, density_air, density_ice, density_lmt, perm_air
!INTF_ON
...
!* common variables
real    (kind=jprb), intent ( in) :: fv_melt, fm_melt
real    (kind=jprb), intent ( in) :: density_snow        ! [kg m^-3]
