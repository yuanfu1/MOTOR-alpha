...
MODULE rttov_tessem_mod
  ...
  PRIVATE
  PUBLIC :: rttov_tessem, rttov_tessem_tl, rttov_tessem_ad
  ...
  !> Structure holding neural network data
  TYPE tessem_net
  ...
  !> Neural network for H-pol emissivities
  TYPE(tessem_net) :: net_h
  !> Neural network for V-pol emissivities
...
CONTAINS
  ...
  !> Apply neural net to inputs to obtain emissivity
  !! @param[in]       net       neural network data
  !! @param[in]       x         neural network inputs
  !! @param[in,out]   y         neural network outputs
  ...
  !> Return H- and V-pol emissivities for given frequency, zenith angle, T-skin
  !! salinity and wind speed
  !! @param[in]     freq        frequency (GHz)
  ...
  !! @param[out]    emis_h      calculated H-pol emissivity
  !! @param[out]    emis_v      calculated V-pol emissivity
  ...
  !> TL of neural net calculation
  !! @param[in]       net       neural network data
  !! @param[in]       x         neural network inputs
  !! @param[in]       x_tl      neural network input perturbations
  !! @param[in,out]   y_tl      neural network output perturbations
  ...
  !> TL of TESSEM2 emissivity calculation
  !! @param[in]     freq           frequency (GHz)
  !! @param[in]     theta          zenith angle (degrees)
  !! @param[in]     windspeed      wind speed (m/s)
  !! @param[in]     tskin          skin temperature (K)
  ...
  !! @param[in]     tskin_tl       skin temperature perturbation
  !! @param[in]     salinity_tl    salinity perturbation
  !! @param[out]    emis_h_tl      H-pol emissivity perturbation
  !! @param[out]    emis_v_tl      V-pol emissivity perturbation
  ...
  !> AD of neural net calculation
  !! @param[in]       net       neural network data
  !! @param[in]       x         neural network inputs
  !! @param[in,out]   x_ad      neural network input increments
  !! @param[in]       y_ad      neural network output increments
  ...
  !! @param[in,out] tskin_ad       skin temperature increment
  !! @param[in,out] salinity_ad    salinity increment
  !! @param[in]     emis_h_ad      H-pol emissivity increment
  !! @param[in]     emis_v_ad      V-pol emissivity increment
